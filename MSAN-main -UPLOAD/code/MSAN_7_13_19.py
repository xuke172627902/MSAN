...
class MSCA(nn.Module):
    ...
    def __init__(self, dim):
        ...
        self.conv_7 = nn.Sequential(nn.Conv2d(dim, dim, (7, 1), 1, (3, 0), groups=dim),
                                    nn.Conv2d(dim, dim, (1, 7), 1, (0, 3), groups=dim))
        self.conv_11 = nn.Sequential(nn.Conv2d(dim, dim, (13, 1), 1, (6, 0), groups=dim),
                                     nn.Conv2d(dim, dim, (1, 13), 1, (0, 6), groups=dim))
        self.conv_21 = nn.Sequential(nn.Conv2d(dim, dim, (19, 1), 1, (9, 0), groups=dim),
                                     nn.Conv2d(dim, dim, (1, 19), 1, (0, 9), groups=dim))
...
if __name__ == '__main__':
    ...
    model = MSAN(num_in_ch=3, num_out_ch=3, scale=4, num_feat=40, num_block=15, d_atten=64, conv_groups=1)
